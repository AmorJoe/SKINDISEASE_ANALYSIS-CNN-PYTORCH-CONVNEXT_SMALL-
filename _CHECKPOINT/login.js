...
if (signupFullname) {
    validateInput(signupFullname, document.getElementById('signup-fullname-error'), validateName);
}
if (signupPassword) {
...
if (signupForm) {
    signupForm.addEventListener('submit', async function (e) {
        ...
        if (nameError || emailError || passError) {
            if (nameError) document.getElementById('signup-fullname-error').textContent = nameError;
            ...
            if (data.status === 'success') {
                ...
                if (data.errors) {
                    ...
                    if (data.errors.full_name) {
                        document.getElementById('signup-fullname-error').textContent = data.errors.full_name[0];
                    }
                } else {
