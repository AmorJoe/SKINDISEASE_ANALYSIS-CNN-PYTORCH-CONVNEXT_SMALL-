...
urlpatterns = [
    ...
    path('appointments/cancel/<int:appointment_id>', CancelAppointmentView.as_view(), name='cancel_appointment'),
    path('appointments/delete/<int:appointment_id>', DeleteAppointmentView.as_view(), name='delete_appointment'),
